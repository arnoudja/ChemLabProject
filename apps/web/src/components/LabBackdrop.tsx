/** Soft illustrated lab atmosphere (Omarchy Hackerman tints). */
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      >
        <defs>
          <linearGradient id="glass" x1="80" y1="40" x2="240" y2="280" gradientUnits="userSpaceOnUse">
            <stop stopColor="#3E4058" stopOpacity="0.95" />
            <stop offset="1" stopColor="#151622" stopOpacity="0.8" />
          </linearGradient>
          <linearGradient id="liquid" x1="120" y1="180" x2="200" y2="280" gradientUnits="userSpaceOnUse">
            <stop stopColor="#82FB9C" stopOpacity="0.85" />
            <stop offset="1" stopColor="#4FE88F" stopOpacity="0.5" />
          </linearGradient>
        </defs>
        <path d="M118 48h84l8 28h-100l8-28z" fill="#86A7DF" opacity="0.7" />
        <path
        ...
        <path
          ...
          fill="url(#liquid)"
        />
        <circle cx="148" cy="236" r="6" fill="#DDF7FF" opacity="0.45" />
        <circle cx="176" cy="248" r="4" fill="#DDF7FF" opacity="0.3" />
        <path
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(130,251,156,0.14), transparent)',
        }}
      />
    </div>
  )
