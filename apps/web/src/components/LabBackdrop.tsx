  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      >
        <defs>
          <linearGradient id="glass" x1="80" y1="40" x2="240" y2="280" gradientUnits="userSpaceOnUse">
            <stop stopColor="#2A3540" stopOpacity="0.95" />
            <stop offset="1" stopColor="#121820" stopOpacity="0.8" />
          </linearGradient>
          <linearGradient id="liquid" x1="120" y1="180" x2="200" y2="280" gradientUnits="userSpaceOnUse">
            <stop stopColor="#5EB8B0" stopOpacity="0.85" />
            <stop offset="1" stopColor="#2F6F6A" stopOpacity="0.55" />
          </linearGradient>
        </defs>
        <path d="M118 48h84l8 28h-100l8-28z" fill="#AEBBC6" opacity="0.65" />
        <path
        ...
        <path
          ...
          fill="url(#liquid)"
        />
        <circle cx="148" cy="236" r="6" fill="#F1F5F7" opacity="0.45" />
        <circle cx="176" cy="248" r="4" fill="#F1F5F7" opacity="0.3" />
        <path
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(94,184,176,0.16), transparent)',
        }}
      />
    </div>
  )
